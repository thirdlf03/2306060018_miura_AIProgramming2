...
class TestRepository:
    ...
    def test_get_available_countries_success(self, mock_get, sample_countries):
        ...
        mock_get.assert_called_once_with("https://date.nager.at/api/v3/AvailableCountries")
    ...
    @patch('repository.requests.get')
    def test_get_public_holidays_success(self, mock_get, sample_api_response, sample_holidays):
        ...
        mock_get.assert_called_once_with("https://date.nager.at/api/v3/PublicHolidays/2025/JP")
    ...
    def test_get_next_public_holidays_success(self, mock_get, sample_api_response):
        ...
        assert len(result) == 2
        mock_get.assert_called_once_with("https://date.nager.at/api/v3/NextPublicHolidays/JP")
    ...
    def test_load_favorites_existing_file(self, mock_path, mock_read_csv, sample_holidays):
        ...
        # CSVデータのモック
        csv_data = [
            {"date": "2025-01-01", "name": "New Year's Day", "local_name": "元日", "country_code": "JP"},
            {"date": "2025-01-13", "name": "Coming of Age Day", "local_name": "成人の日", "country_code": "JP"}
        ]
